...
layui.define(['element', 'common'], function (exports) {
	 ...
	 * @param {Object} data
	 */
    function getHtml(menu_data) {
        var ulHtml = '';
        for (var n = 0; n < menu_data.length; n++) {
            var data = menu_data[n].children;
            ulHtml += '<ul class="layui-nav layui-nav-tree beg-navbar menu_num_'+ n +'"';
            if (n > 0) {
                ulHtml += 'style="display: none"';
            }
            ulHtml += '>';
