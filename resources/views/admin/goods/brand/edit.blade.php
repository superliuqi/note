    ...
    <div style="margin: 15px;">
        <form class="layui-form" method="post">
            ...
            <div class="layui-form-item">
                ...
                <a href="{{ isset($item['logo']) ? $item['logo'] : '' }}" target="_blank"><img src="{{ isset($item['logo']) ? $item['logo'] : '' }}" width="50" style="display: {{ isset($item['logo']) ? : 'none' }};"></a>
...
@section('footer')
    ...
    <script>
        layui.config({
            ...
            //图片上传
            {!! \App\Libs\Upload::getPlupload('band') !!}
        });
