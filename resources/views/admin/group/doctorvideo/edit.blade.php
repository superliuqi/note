                ...
                <div class="layui-field-box">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="video" lay-verify="required" lay-errormsg="视频链接不能为空" autocomplete="off" class="layui-input">
                        </div>
                    </div>
...
@section('footer')
    ...
    <script>
        layui.config({
            ...
            //图片上传
            {!! \App\Libs\Upload::getPlupload('doctor_video') !!}
