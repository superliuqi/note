    ...
    <div style="margin: 15px;">
        <form class="layui-form" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="section_chief" id="" class="radio-box">
                        <option value=""></option>
                        @foreach($chief as $lk=>$lv)
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="area" lay-verify="required" lay-errormsg="请输入大区" autocomplete="off" class="layui-input" value="">
                </div>
            </div>
