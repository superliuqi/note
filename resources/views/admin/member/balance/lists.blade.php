...
@section('content')
    <div class="layui-form searchButton" style="margin-top: 8px;">
        <div class="search_input">
            ...
            <div class="layui-inline">
                <select name="event">
                    <option value=""></option>
                    @foreach(\App\Models\BalanceDetail::EVENT_DESC as $key => $value)
    ...
    <table class="layui-table" lay-data="{url:'{{ url('balance/lists_ajax') }}', page:true, id:'row_list'}" lay-filter="row_list">
        <thead>
        <tr>
