...
@section('content')
    ...
    <table class="layui-table" lay-data="{url:'{{ url('gold/lists_ajax') }}', page:true, id:'row_list'}" lay-filter="row_list">
        <thead>
        <tr>
            <th lay-data="{field:'id', width:80, sort: true}">ID</th>
            <th lay-data="{field:'username', width:200, sort: true}">用户名</th>
            <th lay-data="{field:'amount',width:100,toolbar:'#amountTpl'}">金额</th>
