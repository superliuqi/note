    ...
    <div style="margin: 15px;">
        <form class="layui-form" method="post" onsubmit="return false">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="url" lay-verify="required" lay-errormsg="视频地址不能为空" autocomplete="off" class="layui-input">
                </div>
            </div>
...
@section('footer')
    ...
    <script>
        layui.config({
            ...
            //图片上传
            {!! \App\Libs\Upload::getPlupload('yuvideo') !!}
            //加载编辑器
