    ...
    <div style="margin: 15px;">
        <form class="layui-form" method="post">
            ...
            <div class="layui-form-item">
                ...
                <a href="{{ isset($item['rem_image']) ? $item['rem_image'] : '' }}" target="_blank"><img src="{{ isset($item['rem_image']) ? $item['rem_image'] : '' }}" width="50" style="display: {{ isset($item['image']) ? : 'none' }};"></a>
                <input type="hidden" value="" name="rem_image" lay-verify="required" lay-errormsg="请上传图片">
            </div>
